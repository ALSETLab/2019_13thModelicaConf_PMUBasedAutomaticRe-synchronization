...
class Copyright "Disclaimer<html>
  <p>The package 'Modelica2019Germany_ResynchOperation.mo' is including the models presented in the conference paper 'Modeling of PMU-Based Automatic Re-synchronization Controls for DER Generators in Power Distribution Networks using Modelica language' at 13th International Modelica Conference, Regensburg, Germany, March 4–6, 2019. </p>
<p>Copyright March 2019 - Biswarup Mukherjee, IIT Bombay, India & Prof. Luigi Vanfretti, Rensselaer Polytechnic Institute, Troy, NY.</p>
